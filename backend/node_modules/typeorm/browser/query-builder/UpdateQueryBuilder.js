...
var UpdateQueryBuilder = /** @class */ (function (_super) {
    ...
    UpdateQueryBuilder.prototype.createUpdateExpression = function () {
        ...
        EntityMetadataUtils.createPropertyPath(valuesSet).forEach(function (propertyPath) {
            var column = _this.expressionMap.mainAlias.metadata.findColumnWithPropertyPath(propertyPath);
