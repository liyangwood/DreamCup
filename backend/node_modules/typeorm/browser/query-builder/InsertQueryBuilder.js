...
var InsertQueryBuilder = /** @class */ (function (_super) {
    ...
    InsertQueryBuilder.prototype.createInsertExpression = function () {
        ...
        var columns = this.expressionMap.mainAlias.metadata.columns.filter(function (column) { return !column.isGenerated; });
        ...
        var columnNames = columns.map(function (column) { return _this.escape(column.databaseName); }).join(", ");
        // generate sql query
